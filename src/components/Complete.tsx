...
const MEDAL_COLORS: Record<BadgeTier, { body: string; shine: string; dark: string; ribbon: string }> = {
  bronze:  { body: '#CD7F32', shine: '#e8a050', dark: '#8B4513', ribbon: '#7B3F00' },
  silver:  { body: '#C0C0C0', shine: '#e8e8e8', dark: '#888888', ribbon: '#606060' },
  gold:    { body: '#FFD700', shine: '#ffe84d', dark: '#B8960C', ribbon: '#CC8800' },
  diamond: { body: '#A8EDFF', shine: '#ffffff', dark: '#3BBCDC', ribbon: '#1A8FB0' },
}
...
function Medal({ tier }: { tier: BadgeTier }) {
  ...
  return (
    <svg width="90" height="108" viewBox="0 0 90 108" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      {/* Top shine arc */}
      <ellipse cx="35" cy="60" rx="10" ry="6" fill="white" opacity={isDiamond ? 0.4 : 0.2} transform="rotate(-30 35 60)" />
      {/* Tier shape symbol */}
